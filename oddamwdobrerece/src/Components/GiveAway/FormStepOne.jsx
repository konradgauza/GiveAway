            ...
            <div className="step-one-body">
                ...
                <div className="step-one-form">
                    ...
                    <div className="form-checkbox-handler">
                        <input type="checkbox" className="checkbox" checked={checkbox1} onChange={toggleCheck1}/>
                        <p className="checkbox-text"> ubrania, które nadają się do ponownego użycia</p>
                    </div>
                    <div className="form-checkbox-handler">
                        <input type="checkbox" className="checkbox" checked={checkbox2}  onChange={toggleCheck2}/>
                        <p className="checkbox-text"> ubrania, do wyrzucenia</p>
                    </div>
                    <div className="form-checkbox-handler">
                        <input type="checkbox" className="checkbox" checked={checkbox3}  onChange={toggleCheck3}/>
                        <p className="checkbox-text"> zabawki</p>
                    </div>
                    <div className="form-checkbox-handler">
                        <input type="checkbox" className="checkbox" checked={checkbox4}  onChange={toggleCheck4}/>
                        <p className="checkbox-text"> ksiażki</p>
                    </div>
                    <div className="form-checkbox-handler">
                        <input type="checkbox" className="checkbox" checked={checkbox5}  onChange={toggleCheck5}/>
